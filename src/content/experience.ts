...
export const experienceContent: ExperienceContent = {
  kicker: "Career & Roles",
  title: "Professional Experience & Operational Journey",
  description:
    "A chronological journey through software development, quality engineering, systems automation, and institutional network operations.",
  items: [
    {
      id: "asaas-ai-qa",
      company: "Asaas AI",
      ...
      responsibilities: [
        ...
        "Reviewed plans, feasibility studies, and product readiness before launch.",
      ],
      technologies: [
        "QA Testing",
        "Quality Standards",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Deliver system integrations with external partner institutions.",
      ],
      technologies: [
        "Project Management",
        "System Integration",
    ...
    },
    {
      ...
      responsibilities: [
        "Developed backend service logic using .NET and SQL databases.",
        "Built web application features and interfaces.",
        "Performed software testing and systematic troubleshooting.",
      ],
      technologies: [
        ".NET",
        "SQL",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Coordinated with technicians, documented equipment faults, and ensured safe restart procedures.",
      ],
      technologies: [
        "PLC",
        "Control Loops",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Documented incidents and suggested network stability improvements.",
      ],
      technologies: [
        "LAN / Wi-Fi",
        "Routers & Switches",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Followed up on purchasing requirements and supplier communication.",
      ],
      technologies: [
        "Customer Relations",
        "Inventory Data",
