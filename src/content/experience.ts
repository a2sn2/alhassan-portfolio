...
export const experienceContent: ExperienceContent = {
  ...
  items: [
    ...
    },
    {
      ...
      responsibilities: [],
      technologies: [".NET", "SQL", "Accounting Systems", "Software Development"],
    },
    {
      ...
      responsibilities: [],
      technologies: [".NET", "SQL", "Web Features", "Testing", "Troubleshooting"],
    },
    {
      ...
      responsibilities: [],
      technologies: ["Ticketing Systems", "Compliance Policies", "Customer Service"],
    },
    {
      ...
      responsibilities: [],
      technologies: ["PLC", "Control Loops", "Wiring", "Sensors", "Fault Documentation"],
    },
    {
      ...
      responsibilities: [],
      technologies: ["LAN / Wi-Fi", "Routers & Switches", "Structured Cabling", "Network Maintenance"],
    },
    {
      ...
      responsibilities: [],
      technologies: ["Customer Relations", "Inventory Data", "Invoicing", "Purchasing"],
    },
    {
      ...
      responsibilities: [],
      technologies: ["Administration", "Scheduling", "Event Logistics", "Coordination"],
    },
  ],
};
