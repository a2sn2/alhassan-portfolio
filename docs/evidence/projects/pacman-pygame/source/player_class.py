...
class Player:
    ...
    def draw(self):
        ...
        # Drawing the grid pos rect pygame.draw.rect(self.app.screen, RED, (self.grid_pos[
        # 0]*self.app.cell_width+TOP_BOTTOM_BUFFER//2, self.grid_pos[1]*self.app.cell_height+TOP_BOTTOM_BUFFER//2,
