...
<form class="" action="view.php" method="get">
      ...
      <input class="input" name="type" id="type"   type="text" value="<?php echo $type="show"; ?>">
        <label>ID:
        <input class="input" name="id" id="id"   type="text" ></label>
        <input type="submit" name="showdata" id="sub" class="btns" value="details" disabled/>
...
<input class="input" name="type" id="type"   type="text" value="<?php echo $type="edit"; ?>">
      <label>ID:
        <input class="input" name="id" id="id1"   type="text" ></label>
    
        <input type="submit" name="editdata" id="editb" class="btns" value="edit" disabled />
...
<form class="" action="delete.php" method="post">
    <input class="input" name="id" id="id2"   type="text" >
    <input type="submit"  name="editdata" id="del" class="btns" value="delete" disabled />
...
if(<?php echo $_GET['reg'] ?> == true){
    <?php $title= $_GET['title'] ?>
alert("successfully Added <?php echo $title ?>");

location.href="tableview.php";
...
if(<?php echo $_GET['succ'] ?> == true){
 
    <?php $title= $_GET['title'] ?>
alert("successfully updated <?php echo $title ?>");
...
if(<?php echo $_GET['wrong'] ?> == true){
 
    <?php $title= $_GET['title'] ?>

 alert("couldn't update <?php echo $title ?> because you can't leave one of the field empty");
